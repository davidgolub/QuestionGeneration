...
dataset_path = 'datasets/newsqa_unsupervised_large'
...
language_model_loader = LanguageModelLoader(dataset_path, tokenizer_type=constants.TOKENIZER_TAB,
	context_tokenizer_type=constants.TOKENIZER_TAB)
...
language_model.config['gpu_mode'] = True
...
train_predictions = language_trainer.predict(dataset_type=constants.DATASET_TRAIN, 
            epoch_num=10, max_length=25, beam_size=5)

utils.save_lines(train_predictions, 'logs/newsqa_saved_data/train_predictions_epoch_8.txt')
