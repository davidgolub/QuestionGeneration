...
utils.save_lines(train_predictions, 'logs/newsqa_saved_data/dummy5_train_predictions_epoch_6.txt')
utils.save_lines(dev_predictions, 'logs/newsqa_saved_data/dummy5_validation_predictions_epoch_6.txt')
utils.save_lines(test_predictions, 'logs/newsqa_saved_data/dummy5_test_predictions_epoch_6.txt')
