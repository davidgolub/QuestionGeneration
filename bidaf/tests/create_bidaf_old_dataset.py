...
save_directory = 'newsqa_unsupervised_old'
utils.check_dir(save_directory)

shared_path='newsqa/shared_train.json'
dev_path= 'newsqa/data_train.json'
base_path = '../datasets/newsqa_unsupervised_old/train'
gen_questions_path = '%s/predictions.txt' % base_path#'%s/outputs.txt' % base_path#, 'newsqa/', 'newsqa/']
