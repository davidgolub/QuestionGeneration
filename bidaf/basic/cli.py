...
flags.DEFINE_string("baseline_dir", "data/squad", "Squad baseline directory")
flags.DEFINE_boolean("use_special_token", False, "Use special token to differentiate squad and newsqa? (False)")
flags.DEFINE_integer("sup_unsup_ratio", 5, "Ratio between supervised and unsupervised data")
flags.DEFINE_float("var_decay", 0.999, "Exponential moving average decay for variables [0.999]")
flags.DEFINE_integer("k", 5, "number of top results to use")
flags.DEFINE_string("model_name", "basic", "Model name [basic]")
flags.DEFINE_string("data_dir", "data/squad", "Data dir [data/squad]")
flags.DEFINE_string("run_id", "0", "Run ID [0]")
flags.DEFINE_string("out_base_dir", "out", "out base dir [out]")
flags.DEFINE_integer("gpu_idx", 1, "starting gpu index")
